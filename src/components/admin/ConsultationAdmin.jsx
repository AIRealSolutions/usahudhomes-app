...
function ConsultationAdmin() {
  ...
  async function updateConsultationStatus(consultationId, newStatus) {
    const result = await consultationService.updateConsultation(consultationId, { status: newStatus })
    if (result.success) {
      loadConsultations()
    }
  }
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-md space-y-2">
                ...
                <p className="text-sm"><strong>Name:</strong> {editingConsultation.customer_name}</p>
                <p className="text-sm"><strong>Email:</strong> {editingConsultation.customer_email}</p>
                <p className="text-sm"><strong>Phone:</strong> {editingConsultation.customer_phone}</p>
              </div>
              ...
              <div>
                ...
                {editForm.agent_id && editForm.agent_id !== editingConsultation.agent_id && (
            ...
            <div className="p-6 border-t flex gap-3 justify-end">
              ...
              <Button onClick={saveConsultation} className="bg-purple-600 hover:bg-purple-700">
