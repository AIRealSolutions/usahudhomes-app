#!/usr/bin/env python3
"""
Production Flask App for USAhudHomes.com
...
if __name__ == '__main__':
    print("🏠 Starting USAhudHomes.com Production Server...")
    print("📊 Data loaded:")
    print(f"   Properties: {len(data_service.properties)}")
    print(f"   Leads: {len(data_service.leads)}")
    print(f"   Brokers: {len(data_service.brokers)}")
    print("\n🌐 Server running on http://0.0.0.0:5000")
    print("📱 React app served at root URL")
