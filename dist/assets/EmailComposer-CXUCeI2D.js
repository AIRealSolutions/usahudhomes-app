const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/eventService-BD1RtTp0.js","assets/index-BhZEPBTy.js","assets/vendor-radix-CV_Kdfn-.js","assets/vendor-react-DgS-gCnO.js","assets/vendor-supabase-Noj9FdVg.js","assets/vendor-charts-bVZ3-e_D.js","assets/index-C_uxqA6L.css"])))=>i.map(i=>d[i]);
import{c as v}from"./vendor-supabase-Noj9FdVg.js";import{j as a}from"./vendor-radix-CV_Kdfn-.js";import{r as c}from"./vendor-react-DgS-gCnO.js";import{u as S,M as D,X as N,S as T,c as I}from"./index-BhZEPBTy.js";import{S as P}from"./sparkles-DxkI4wL7.js";import"./vendor-charts-bVZ3-e_D.js";const U=({consultation:l,customer:i,property:e,onSend:$,onCancel:b})=>{const{profile:s}=S(),[o,h]=c.useState(""),[r,g]=c.useState(""),[f,y]=c.useState(""),[d,x]=c.useState(!1),p=[{id:"initial_contact",name:"Initial Contact",subject:`Re: Your Interest in ${e.case_number||"HUD Property"}`,body:`Hi ${i.first_name},
