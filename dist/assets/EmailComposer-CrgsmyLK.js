const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/eventService-BWwVNsCq.js","assets/index-CkOvbHr0.js","assets/vendor-radix-CV_Kdfn-.js","assets/vendor-react-DgS-gCnO.js","assets/vendor-supabase-Noj9FdVg.js","assets/vendor-charts-bVZ3-e_D.js","assets/index-CSWvh_j9.css"])))=>i.map(i=>d[i]);
import{c as v}from"./vendor-supabase-Noj9FdVg.js";import{j as a}from"./vendor-radix-CV_Kdfn-.js";import{r as c}from"./vendor-react-DgS-gCnO.js";import{G as S,h as D,X as N,Z as T,c as I}from"./index-CkOvbHr0.js";import{S as P}from"./sparkles-oD76dcLs.js";import"./vendor-charts-bVZ3-e_D.js";const U=({consultation:l,customer:i,property:e,onSend:$,onCancel:b})=>{const{profile:s}=S(),[o,h]=c.useState(""),[r,g]=c.useState(""),[f,y]=c.useState(""),[d,x]=c.useState(!1),p=[{id:"initial_contact",name:"Initial Contact",subject:`Re: Your Interest in ${e.case_number||"HUD Property"}`,body:`Hi ${i.first_name},
